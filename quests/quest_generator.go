...
func RandomDestroyEnemiesQuest(levelIdFunc LevelIDWithNameFunc) (*DestroyEnemiesQuest, error) {
	...
	level_kill_requirements := []LevelEnemyCountFor100XP{
		...
		{[]Level{deadline}, asteroid, 300},
		{[]Level{deadline}, crowder, 100},
		{[]Level{deadline}, wary, 50},
		{[]Level{deadline}, ufo, 30},
		...
		{[]Level{triskiv}, mothership, 50},
		{[]Level{interdimensional_problems}, baf, 1000},
		{[]Level{timebomb}, asteroid, 1000},
		{[]Level{timebomb}, wary, 10},
		{[]Level{timebomb}, rollingCube, 80},
		{[]Level{inertiac_world}, inertiac, 300},
		{[]Level{numfall}, wary, 10},
		{[]Level{pacifism_live}, crowder, 500},
		{[]Level{waves_blue}, bafBlue, 700},
